                            ...
                            <div class="col-xl-9 float-left">
                                <div class="form-row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('username') is-invalid @enderror" onchange="AdminJs.checkExist('users', 'username', this.value, this)" id="validationCustom01" placeholder="Username" name="username" value="{{ $user->username }}" required>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" onchange="AdminJs.checkExist('users', 'email', this.value, this)" id="validationCustom02" placeholder="email" name="email" value="{{ $user->email }}" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('first_name') is-invalid @enderror" id="validationCustom03" placeholder="First name" name="first_name" value="{{ $user->first_name }}" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('last_name') is-invalid @enderror" id="validationCustom04" placeholder="Last name" name="last_name" value="{{ $user->last_name }}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('address') is-invalid @enderror" id="validationCustom05" placeholder="Address" name="address" value="{{ $user->address }}" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control currency @error('phone') is-invalid @enderror" id="validationCustom06" placeholder="Phone" name="phone" value="{{ $user->phone }}" required>
                                        <div class="invalid-feedback">
